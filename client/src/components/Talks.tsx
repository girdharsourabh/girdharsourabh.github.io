            ...
            <Tabs defaultValue="all" className="w-full">
              ...
              <TabsContent value="all" className="space-y-8">
                {talks.sort((a, b) => {
                  ...
                  <div key={talk.id} className="mb-10 last:mb-0 bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                    <div className="flex flex-col md:flex-row gap-6">
                      <div className="md:w-1/4">
              ...
              <TabsContent value="awards" className="space-y-8">
                {awards.sort((a, b) => {
                  ...
                  <div key={award.id} className="mb-10 last:mb-0 bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                    <div className="flex flex-col md:flex-row gap-6">
                      <div className="md:w-1/4">
                        <span className="text-gray-500 font-medium">{award.date}</span>
                        <div className="mt-2">
                          <Badge variant="outline" className="bg-amber-50 text-amber-700 border-amber-200">
                            <Award className="h-3 w-3 mr-1" /> Award
                          </Badge>
                      ...
                      <div className="md:w-3/4">
                        ...
                        <h4 className="text-gray-700 font-medium mb-3">{award.event}</h4>
